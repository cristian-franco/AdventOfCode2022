...
def check_elf_pair(elf_1_bounds, elf_2_bounds):
    ...
    if (elf_1_lower_bound == elf_2_lower_bound and elf_1_upper_bound == elf_2_upper_bound):
        return True
    elif ( (elf_1_lower_bound <= elf_2_lower_bound) and (elf_1_upper_bound >= elf_2_upper_bound)):
        return True
    elif ( (elf_2_lower_bound <= elf_1_lower_bound) and (elf_2_upper_bound >= elf_1_upper_bound)):
        return True
    else:
        return False


def find_complete_overlaps(elf_1_list, elf_2_list):
    total_overlaps = 0
...
def main():
    ...
    total_overlaps = find_complete_overlaps(elf_1_list, elf_2_list)
